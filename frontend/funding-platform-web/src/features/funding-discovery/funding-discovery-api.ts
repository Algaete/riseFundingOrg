...
export interface DiscoveryClassification { funderKind: number | null; requiresConsortium: boolean | null; requiresInternationalPartner: boolean | null; evidenceUrl: string | null }
...
export const fundingDiscoveryApi = {
  catalogs: (signal?: AbortSignal) => apiClient.get<Pick<OrganizationCatalogs, 'countries' | 'regions' | 'currencies' | 'fundingCategories' | 'fundingTypes' | 'organizationTypes' | 'languages'>>('funding-discovery/catalogs', { signal }),
