...
it('retains a new application draft and retries the same command without locale in its payload', async () => {
  ...
  expect(create.mock.calls[0][1]).toMatchObject({ notes: 'Texto original', projectId: workspaceProject.publicId, fundingOpportunityId: organizationOpportunity.publicId })
})
