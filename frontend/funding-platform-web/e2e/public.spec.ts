...
import { registerOrganizationVerificationTests } from './organization-verification-checks'
...
registerOrganizationVerificationTests(expectNoSeriousAccessibilityViolations)
