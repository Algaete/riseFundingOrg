...
public static class FundingPlatformConfiguration
{
    ...
    [
        ...
        ("AZURE_STORAGE_BLOB_SERVICE_URI", "ProjectAssets:BlobServiceUri"),
        ...
        ("PROJECT_ASSETS_ENABLED", "ProjectAssets:Enabled"),
        ("PROJECT_ASSET_INCOMING_CONTAINER", "ProjectAssets:IncomingContainer"),
        ("PROJECT_ASSET_QUARANTINE_CONTAINER", "ProjectAssets:QuarantineContainer"),
        ("PROJECT_ASSET_TRUSTED_CONTAINER", "ProjectAssets:TrustedContainer"),
        ("PROJECT_ASSET_MAX_IMAGE_BYTES", "ProjectAssets:MaxImageBytes"),
        ("PROJECT_ASSET_MAX_DOCUMENT_BYTES", "ProjectAssets:MaxDocumentBytes"),
        ("PROJECT_ASSET_MAX_PROJECT_BYTES", "ProjectAssets:MaxProjectBytes"),
        ("PROJECT_ASSET_MAX_IMAGE_PIXELS", "ProjectAssets:MaxImagePixels"),
        ("PROJECT_ASSET_UPLOAD_TTL_MINUTES", "ProjectAssets:UploadTtlMinutes"),
        ("PROJECT_ASSET_FINALIZE_LEASE_SECONDS", "ProjectAssets:FinalizeLeaseSeconds"),
        ("PROJECT_ASSET_SCAN_TIMEOUT_SECONDS", "ProjectAssets:ScanTimeoutSeconds"),
        ("PROJECT_ASSET_SCAN_MODE", "ProjectAssets:ScanMode"),
        ("PROJECT_ASSET_DEVELOPMENT_FAKE_RESULT", "ProjectAssets:DevelopmentFakeResult"),
        ...
        ("PROJECT_ASSET_DEFENDER_EVENT_GRID_ENABLED",
            "ProjectAssetDefenderEventGrid:Enabled"),
        ("PROJECT_ASSET_DEFENDER_EVENT_GRID_SUBSCRIPTION_NAME",
            "ProjectAssetDefenderEventGrid:ExpectedSubscriptionName"),
        ("PROJECT_ASSET_DEFENDER_PENDING_SCAN_TIMEOUT_MINUTES",
            "ProjectAssetDefenderEventGrid:PendingScanTimeoutMinutes"),
        ("PROJECT_ASSET_DEFENDER_WATCHDOG_BATCH_SIZE",
            "ProjectAssetDefenderEventGrid:WatchdogBatchSize"),
        ...
        ("OPENAI_EMBEDDINGS_ENABLED", "OpenAI:EmbeddingsEnabled"),
        ("OPENAI_STRUCTURED_OUTPUTS_ENABLED", "OpenAI:StructuredOutputsEnabled"),
        ("OPENAI_ENDPOINT_ORIGIN", "OpenAI:EndpointOrigin"),
        ("OPENAI_API_KEY", "OpenAI:ApiKey"),
        ("OPENAI_PROJECT_ID", "OpenAI:ProjectId"),
        ("OPENAI_EMBEDDING_GOVERNANCE_POLICY_SHA256",
            "OpenAI:RequiredEmbeddingGovernancePolicySha256"),
        ("OPENAI_STRUCTURED_OUTPUT_GOVERNANCE_POLICY_SHA256",
